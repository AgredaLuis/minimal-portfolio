export const translations = {
  en: {
    ...
    testimonials: {
      title: "Some nice words from my past clients",
      items: [
        {
  ...
  items: [
    ...
    footer: {
      ...
      madeBy: "Made with ❤️ by Luis Agreda",
    }
  },
  es: {
    hero: {
    ...
    testimonials: {
      title: "Reseñas de mis clientes anteriores",
      items: [
        {
    ...
    footer: {
      status: "Un espacio disponible para el próximo mes",
      title: "Menos charla. Hagamos algo grandioso juntos",
      madeBy: "Hecho con ❤️ por Luis Agreda",
    }
  },
};