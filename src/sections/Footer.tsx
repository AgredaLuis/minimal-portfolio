      ...
      <div className="section">
        ...
        <div className="grid md:grid-cols-3 md:items-center">
          <div className="md:col-span-2">
            <h2 className="teext-4xl md:text-7xl lg:text-8xl  mt-8 font-extralight" ref={scope}>Enoough talk. Let&apos;s make something great together</h2>
        ...
        <p className="py-16 text-white/30 text-sm">Copyright &copy; Luis Agreda &bull; All rights reserved</p>
      </div>
    </div>
  </footer>;
};
